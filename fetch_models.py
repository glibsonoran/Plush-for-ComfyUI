...
class FetchModels:
    ...
    def fetch_models(self, request_type:RequestMode, key: str=""):
        ...
        if request_type == RequestMode.OPENAI:
            ...
            model_names = ['claude-3-haiku-20240307', 'claude-3-5-haiku-20241022', 'claude-3-sonnet-20240229', 'claude-3-5-sonnet-20240620', 'claude-3-5-sonnet-latest', 'claude-3-opus-20240229']
