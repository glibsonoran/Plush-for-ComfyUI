...
*   Style Prompt: Can now use remote services and models from: ChatGPT, Grog and Anthropic, whereas before it could only use ChatGPT. As a result it now requires you to connect the *AI Chooser* node in order to select the service and model you want to use.
**************
