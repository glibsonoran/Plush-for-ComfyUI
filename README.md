# Plush-for-ComfyUI
****
**You don't need an OpenAI key to use Advanced Prompt Enhancer with Groq or open source LLM's.  You can use them for free.  But if you want to use it with ChatGPT or Claude3 then:**
