...
Alternatively you can enter individual model names directly by converting the *Optional Models* drop-down widget into an input and attach the Plush `Text (Any)` node to it.
