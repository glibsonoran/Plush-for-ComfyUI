...
*  **New node: 'Tagger'**   This node allows you to add tags to any text block.  Tags can be added to the beginning, middle or end of the text block.  This facilitates adding lora, weighted text, or other prompt specific tags to prompts generated by AI.
******************
