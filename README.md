...
### Updates:
1/5/23 @12:02pm PST: 
*  **Plush-for-ComfyUI will no longer get your API key from the .json file**  You must now store you OpenAI API key in an environment variable.  [See instructions below:](#your-openai-api-key)
