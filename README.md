...
*   **Update to Advanced Prompt Enhancer, bug fix user-entered models are now in the `opt_models.txt` file:**
    ...
    *   The new file `opt_models.txt` in the */Plush-for-ComfyUI* directory is created during first startup after updating the Plush node suite.  It will not appear until after you've restarted ComfyUI following a: Manager Update, or a Manager initial install, or a  git clone, or a git pull to version 1.21.16 or higher.
